...
begin
  ...
  // begin
  // ShowMessage('mamacoPRETO perdeu pq ele mesmo ganhando ele ainda é preto');
  // end;
end;
...
begin
  ...
  if vez = 0 then
  begin
    Label1.Caption := 'É o turno do Macaco Branco!';
  ...
  begin
    Label1.Caption := 'É o turno do Macaco Preto!';
  ...
  begin
    mvb := mvb + 1;
    ShowMessage('mamaco BRANCO ganhou, pq ele não é preto');
  ...
  begin
    mvp := mvp + 1;
    ShowMessage('mamaco PRETO ganhou, pq ele não é branco');
    img1.Picture := imgB.Picture;
    img2.Picture := imgB.Picture;
    img3.Picture := imgB.Picture;
    img4.Picture := imgB.Picture;
